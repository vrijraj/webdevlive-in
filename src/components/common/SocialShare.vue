        ...
        <v-row>
            <v-col md="6" cols="12" sm="6">
                <v-card class="pa-5 elevation-0" outlined :class="$vuetify.theme.dark == true ? 'darkModeCard' : 'whiteThemeCard'" rel="noreferrer" href="https://twitter.com/WebDevLiveIndia" target="_blank">
                    ...
                    <p class="google-font mt-5 mb-0" style="font-size:120%">Follow <b>@WebDevIndia</b></p>
                </v-card>
            </v-col>
            <v-col md="6" cols="12" sm="6">
                <v-card class="pa-5 elevation-0" outlined :class="$vuetify.theme.dark == true ? 'darkModeCard' : 'whiteThemeCard'" to="/faq">
                    ...
                    <p class="google-font mt-5 mb-0" style="font-size:120%">See FAQs</p>
                </v-card>
            </v-col>
        </v-row>
    </v-container>
